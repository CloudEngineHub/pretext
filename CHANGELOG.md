...
- In engines Pretext doesn't recognize, and in runtimes such as Node, Bun or jsdom, rich-inline layout now breaks between items only where their joined text has a break opportunity, as in Chrome and Firefox, instead of at every item boundary.
